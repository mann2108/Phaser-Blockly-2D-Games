...
function preload ()
{
    this.load.image('sky', 'assets/badtouch8.jpg');
   // this.load.image('girl','assets/badtouch7.png');
  //   this.load.image('boy','assets/badtouch4.jpg');
  //  this.load.image('poster','assets/poster.jpg');
   //   this.load.image('kid','assets/bad.png');
...
function create ()
{
    ...
    //girl
   // girl = this.physics.add.image(123,290,'girl');
   
    //boy
   //  boy= this.physics.add.image(600,260,'boy');
