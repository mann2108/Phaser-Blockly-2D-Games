...
function create ()
{
    ...
    basket.create(700,90,'basket');
    balloon=  this.physics.add.image(700,80,'balloon');
 ...
 /*   //dew
  ...
  //  this.add.image('730','470','bucket');
    ...
    arrow.create(450,500,'arrow');
    arrow.create(300,80,'arrow');
    arrow.create(450,80,'arrow');
    arrow.create(600,80,'arrow');
    arrow.create(450,290,'arrow');
    arrow.create(600,290,'arrow');
    arrow.create(320,500,'arrow');
    arrow.create(220,290,'arrow');
    //up
 ...
 //   arrow.create(190,290,'left');
   //    arrow.create(320,290,'left');
    ...
    //down
    arrow.create(400,190,'down');
    arrow.create(250,400,'down');

   
     //colors
    basket.create(700,310,'box');

   // border= this.physics.add.staticGroup();
   // border.create(620,300,'border');
    border=  this.physics.add.image(620,300,'border');
     colors=  this.physics.add.image(700,250,'colors');
    
    // The player and its settings
    player = this.physics.add.sprite(120, 290, 'dude');
...
player.anims.play('turn',true);
 ...
 this.physics.add.collider(player, border);
    ...
    this.physics.add.overlap(player,colors,stopWater,null,this);
